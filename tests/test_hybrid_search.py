...
class TestFTS5Sync(unittest.TestCase):
    ...
    def test_store_chunk_updates_fts(self):
        ...
        self.vs.store_chunk("Brian Meyer lives in Portland", _dummy_vec(), source="whatsapp")
...
class TestFTS5Search(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # Populate test data
        self.vs.store_chunk("Brian Meyer lives in Portland Oregon", _dummy_vec(0.1), source="whatsapp")
...
class TestHybridSearch(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.vs.store_chunk("Brian Meyer lives in Portland Oregon", _dummy_vec(), source="whatsapp")
