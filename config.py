...
REL_AUDIT_LOW_CONFIDENCE_THRESHOLD = float(
    os.getenv("MOLLY_REL_AUDIT_LOW_CONFIDENCE_THRESHOLD", "0.35")
)
REL_AUDIT_RELATED_TO_WARN_THRESHOLD = int(
    os.getenv("MOLLY_REL_AUDIT_RELATED_TO_WARN_THRESHOLD", "3")
)
REL_AUDIT_MAX_MODEL_BATCH = int(
    os.getenv("MOLLY_REL_AUDIT_MAX_MODEL_BATCH", "30")
)
